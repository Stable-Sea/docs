...
<Steps>
  ...
  <Step title="Create Customer">
    ...
    ```bash
    curl -X POST "https://api-sandbox.stablesea.xyz/v1/customers" \
      -H "Authorization: Bearer YOUR_API_KEY" \
      -H "Content-Type: application/json" \
      -d '{
    ...
    **Response:**
    ...
    <Tip>
      Save the customer `id` (starts with `org_`) as you'll need it for subsequent API calls. Note that new customers typically start in `COMPLIANCE_HOLD` status and may need approval before becoming `ACTIVE`.
    </Tip>
  ...
  <Step title="Create External Payment Instruments">
    ...
    **Create Payin Payment Instrument (USDC Solana Address):**
    ```bash
    curl -X POST "https://api-sandbox.stablesea.xyz/v1/customers/CUSTOMER_ID/external_payment_instruments" \
      -H "Authorization: Bearer YOUR_API_KEY" \
      -H "Content-Type: application/json" \
      -d '{
  ...
  <Step title="Create Offerings">
    ...
    ```bash
    curl -X POST "https://api-sandbox.stablesea.xyz/v1/customers/CUSTOMER_ID/offerings" \
      -H "Authorization: Bearer YOUR_API_KEY" \
      -H "Content-Type: application/json"
    ```
  ...
  <Step title="Create Quote">
    ...
    ```bash
    curl -X POST "https://api-sandbox.stablesea.xyz/v1/customers/CUSTOMER_ID/quotes" \
      -H "Authorization: Bearer YOUR_API_KEY" \
      -H "Content-Type: application/json" \
      -d '{
        "offering_id": "string",
  ...
  <Step title="Create Order">
    ...
    ```bash
    curl -X POST "https://api-sandbox.stablesea.xyz/v1/customers/CUSTOMER_ID/orders" \
      -H "Authorization: Bearer YOUR_API_KEY" \
      -H "Content-Type: application/json" \
  ...
  <Step title="Monitor Order Status">
    ...
    ```bash
    curl -X GET "https://api-sandbox.stablesea.xyz/v1/customers/CUSTOMER_ID/orders/ORDER_ID" \
      -H "Authorization: Bearer YOUR_API_KEY" \
      -H "Content-Type: application/json"
    ```
