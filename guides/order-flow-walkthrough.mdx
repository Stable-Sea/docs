...
<Steps>
  <Step title="Authentication">
    ...
    ```bash
    # Test authentication
    curl -X GET "https://api-sandbox.stablesea.xyz/v1/liquidity-providers" \
  ...
  <Step title="Get Current Exchange Rate (Optional)">
    ...
    ```bash
    curl -X GET "https://api-sandbox.stablesea.xyz/v1/liquidity-providers/ALPHA/exchange-rate" \
      -H "Authorization: Bearer YOUR_API_KEY" \
      -H "Content-Type: application/json"
    ```
