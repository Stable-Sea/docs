...
```bash
curl -X GET "https://api-sandbox.stablesea.xyz/v1/customers" \
...
API keys are 64-character lowercase hexadecimal strings (e.g., `655fe77482a25380aee99e05b6f6cf60ebe44a23f81e1ee611083afd456567a8`)
