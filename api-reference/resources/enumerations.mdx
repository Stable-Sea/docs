...
| Status            | Description                                                         |
| ----------------- | ------------------------------------------------------------------- |
| `COMPLIANCE_HOLD` | Customer is under compliance review and cannot perform transactions |
| `ACTIVE`          | Customer has been approved and can perform transactions             |
...
| Method              | Description                                                 |
| ------------------- | ----------------------------------------------------------- |
| `ETHEREUM`          | Ethereum blockchain transactions                            |
| `SOLANA`            | Solana blockchain transactions                              |
| `COP_BANK_TRANSFER` | Colombian Peso bank transfer                                |
| `MXN_SPEI`          | Mexican SPEI (Sistema de Pagos Electrónicos Interbancarios) |
| `BRL_BANK_TRANSFER` | Brazilian Real bank transfer                                |
